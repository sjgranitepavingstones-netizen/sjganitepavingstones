  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        "ken-burns": { "0%": { transform: "scale(1) translate(0,0)" }, "100%": { transform: "scale(1.08) translate(-0.6%, -0.6%)" } },
        "gold-pulse": { "0%, 100%": { opacity: "0.6" }, "50%": { opacity: "1" } },
      ...
      animation: {
        ...
        "ken-burns": "ken-burns 36s ease-out infinite alternate",
